...
export default function PaymentCancelled() {
  ...
  const payment = paymentCancel?.payment;

  return (
    <div className="flex items-center p-10 justify-center min-h-screen bg-gradient-to-br from-red-50 to-rose-100 px-4">
      <div className="bg-white rounded-3xl py-2 shadow-2xl px-10 max-w-lg w-full text-center animate-fadeIn">
        ...
        {payment && (
          <div className="bg-red-50 border border-red-200 rounded-xl p-5 mt-6 text-left">
            ...
            <ul className="space-y-2 text-gray-600 text-base">
              ...
              <li>
                ...
                {payment.method?.methodName || "N/A"}
              </li>
              <li>
                <span className="font-medium">Status:</span>{" "}
                {payment.status?.statusName || "Unknown"}
              </li>
              <li>
